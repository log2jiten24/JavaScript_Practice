...
var str1 = "TypeScript is";
var str2 = "my  favourite language";
var str3 = "used for WebDriverIO";
...
console.log('********************************');
fruits.split(",").forEach(function (ele) { return console.log(ele); }); //to print each of the fruits from the array separatelt
console.log('********************************');
