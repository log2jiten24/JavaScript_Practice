...
var minus_results = (a:number , b: number) : number => //no need to write the function keyword 
{
    return a - b ;
}
...
var update_04 = () => console.log('No Parameters - Arrow function without curly braces ');
update_04();
console.log('*******************************************');
...
var update_05 = (p:number , q:number) => p*q ;
