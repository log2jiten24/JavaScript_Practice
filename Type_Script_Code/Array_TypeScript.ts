...
var fruits1 :string[] = ["Apples" , "Mangoes" , "Banana"] ;
...
fruits1.forEach(ele => console.log(ele));
console.log('*****************************************');
...
let fruits3 = [10 , true , "Mandarins" , undefined];
...
let fruits4 : any[] = [true , undefined , null , 10.3 , "Berryfruits"]  ;
console.log('All TS fruit data types :' , fruits4);
console.log('*****************************************');

for (var elements of fruits4) {
...
var values_01 : (string | number)[] = ["Delhi" , 10 , 10.5]  ;
console.log('Combination of two Data Type Array :' , values_01);
console.log('*****************************************');
values_01.forEach(ele => console.log(ele));
console.log('*****************************************');

//Creating two dimensional array 
var myarray : number [][] = [ [10 , 20] , [20 , 30] , [20.5, 10.3]] ; //creating two dimensional array 
...
var myarray_02 : (string | number) [] [] = [ ["abc" , 1] , ["xyz" , 2], [3 , "wyz"] ];
